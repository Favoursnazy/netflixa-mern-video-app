...
export const GET_FAVOURITES_MOVIES_REQUEST = "GET_FAVOURITES_MOVIES_REQUEST";
export const GET_FAVOURITES_MOVIES_SUCCESS = "GET_FAVOURITES_MOVIES_SUCCESS";
export const GET_FAVOURITES_MOVIES_FAIL = "GET_FAVOURITES_MOVIES_FAIL";
export const GET_FAVOURITES_MOVIES_RESET = "GET_FAVOURITES_MOVIES_RESET";

export const DELETE_FAVOURITE_MOVIES_REQUEST =
  "DELETE_FAVOURITE_MOVIES_REQUEST";
export const DELETE_FAVOURITE_MOVIES_SUCCESS =
  "DELETE_FAVOURITE_MOVIES_SUCCESS";
