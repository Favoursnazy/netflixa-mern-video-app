...
export const CREATE_MOVIES_RESET = "CREATE_MOVIES_RESET";

export const UPDATE_MOVIES_REQUEST = "UPDATE_MOVIES_REQUEST";
export const UPDATE_MOVIES_SUCCESS = "UPDATE_MOVIES_SUCCESS";
export const UPDATE_MOVIES_FAIL = "UPDATE_MOVIES_FAIL";
export const UPDATE_MOVIES_RESET = "UPDATE_MOVIES_RESET";
