...
export const getFavouritesMoviesReducer = (
  state = { likedMovies: [] },
  action
) => {
  switch (action.type) {
    case userConstants.GET_FAVOURITES_MOVIES_REQUEST:
      return { isLoading: true };
    case userConstants.GET_FAVOURITES_MOVIES_SUCCESS:
      return { isLoading: false, likedMovies: action.payload };
    case userConstants.GET_FAVOURITES_MOVIES_FAIL:
      return { isLoading: false, isError: action.payload };
    case userConstants.GET_FAVOURITES_MOVIES_RESET:
      return {};
...
//DELTE FAVOURITES MOVIES
export const deleteFavoritesMoviesReducer = (state = {}, action) => {
  switch (action.type) {
