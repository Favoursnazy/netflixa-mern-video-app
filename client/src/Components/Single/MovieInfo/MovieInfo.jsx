      ...
      <div className="xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 right-0 bottom-0">
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          <div className="xl:col-span-1 w-full xl:order-none order-last h-header bg-dry border-gray-800 rounded-lg overflow-hidden">
            <img
              src={
                hasValidUrlProtocol(`${movie?.titleImage}`)
                  ? movie?.titleImage
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10">
              ...
              {/* Flex items */}
              <div className="flex items-center gap-4 font-meduim text-dryGray">
              ...
              <div className="grid sm:grid-cols-5 grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg">
                ...
                {/* Language */}
                <div className="col-span-2 flex-colo font-meduim text-sm">
                  <p>
                    Language: {""}{" "}
            ...
            <div className="col-span-2 md:mt-0 mt-2 flex justify-end">
              <button
                disabled={progress}
                onClick={() => DownloadVideo(movie?.video, movie?.title)}
